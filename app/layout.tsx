...
export const metadata: Metadata = {
  ...
  description: 'منصة مصرية لتبادل المهارات بالوقت. ساعة منك تساوي ساعة من غيرك — علّم غيرك اللي تعرفه، وخد وقت لتتعلم اللي محتاجه.',
  keywords: ['ورّيني', 'تبادل مهارات', 'تعليم اونلاين', 'مصر', 'تبادل وقت', 'skill exchange', 'Egypt'],
  ...
  openGraph: {
    ...
    images: [{ url: '/apple-icon.png', width: 180, height: 180, alt: 'ورّيني' }],
  },
  twitter: {
    card: 'summary',
    title: 'ورّيني — بدل الفلوس، بادل وقتك',
